const About = () => {
  ...
  <div className="grid md:grid-cols-3 gap-8 mt-8">
    <div
       className="aspect-square ai-card text-center rounded-2xl transition-all duration-300 w-72 h-72 flex flex-col justify-center items-center p-8"
      style={{
        transform: 'perspective(800px) rotateX(6deg) rotateY(-6deg)',
        boxShadow: '0 8px 20px rgba(0, 0, 0, 0.12)',
      }}
    >
      <div className="w-16 h-16 bg-ai-blue/10 rounded-xl flex items-center justify-center mx-auto mb-6">
        <svg
          className="w-8 h-8 text-ai-blue"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      <p className="text-muted-foreground leading-relaxed">
        Handle repetitive calls and admin tasks automatically
      </p>
    </div>
    ...
    >
      <div className="w-16 h-16 bg-ai-teal/10 rounded-xl flex items-center justify-center mx-auto mb-6">
        <svg
          className="w-8 h-8 text-ai-teal"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      <p className="text-muted-foreground leading-relaxed">
        Capture more qualified leads around the clock
      </p>
    </div>
    ...
    >
      <div className="w-16 h-16 bg-ai-purple/10 rounded-xl flex items-center justify-center mx-auto mb-6">
        <svg
          className="w-8 h-8 text-ai-purple"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      <p className="text-muted-foreground leading-relaxed">
        Fast, friendly, human-like conversations
      </p>
    </div>
  </div>
</div>
